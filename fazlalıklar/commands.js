module.exports = (Canvas, chalk, Discord, randomPuppy, request, ytdl, fs, client, db, edb, rdb, kdb, ktdb, ardb, prefix, sahip, token, distube, path, got) => {
  ...
  client.on('message', async (message) => {
    ...
    if (message.channel.type === "dm") {
      const embed = new Discord.MessageEmbed()
        .setDescription("Komutlarımız sadece sunucularda çalışmakta <a:unlem:825146178503966770>")
        .setColor("RED")
    ...
    if (komut === "help" || komut === "yardım") {
      if (!args[0]) {
        const embed = new Discord.MessageEmbed()
          ...
          .addFields({
            name: `<a:yldz:825050096567451769> ${prefix}moderasyon`,
            value: "Moderasyon komutlarını listeler"
          }, {
            name: `<a:yldz:825050096567451769> ${prefix}sesli`,
            value: "Sesli komutları listeler"
          }, {
            name: `<a:yldz:825050096567451769> ${prefix}eğlence`,
            value: "Eğlence komutlarını listeler"
          }, {
            name: `<a:yldz:825050096567451769> ${prefix}müzik`,
            value: "Müzik komutlarını listeler"
          }, {
            name: `<a:yldz:825050096567451769> ${prefix}metin`,
            value: "Sohbet komutlarını listeler"
          })
          .setFooter("Daha Fazla Komut İstiyorsanız Bana Ulaşın | Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
          .setTimestamp()
    ...
    if (komut === "moderasyon" || komut === "moderasyon komutları") {
      ...
      const array = [
        ...
        `<a:ayar:822253985427488798> ${prefix}rol-ata: Kayıt komutu için bir kelimeye rol atar \n`,
    ...
    if (komut === "eğlence" || komut === "eğlence komutları") {
      const array = [
        ...
        `<a:oyunkonsolu:825046531312582729> ${prefix}pp: Etiketlenen kişinin profil fotoğrafını atar \n`
      ]
      const embed = new Discord.MessageEmbed()
        .setColor("RANDOM")
        .setTitle("Eğlence Komutları")
        .setDescription(array)
        .setFooter("Yakında Devamı Gelecek... | Created by Saxquatchx", fot.avatarURL({
          dynamic: true
        }))
        .setTimestamp()
        .setAuthor(message.author.username, message.author.avatarURL({
    ...
    if (komut === "müzik") {
      const array = [
        `<a:mzknotas:825045623463346178> ${prefix}müzik-odası: Bir kanalı müzik odası yaparak o kanalda komutsuz şarkı açabilirsiniz \n`,
        ...
        `<a:mzknotas:825045623463346178> ${prefix}döngü: Müziği döngüye alır \n`,
        `<a:mzknotas:825045623463346178> ${prefix}karıştır: Sırayı karıştırır \n`
      ]
      const embed = new Discord.MessageEmbed()
        .setColor("RANDOM")
        ...
        if (kanalvarmı === true) {
          ...
          if (argümanbir.startsWith('<#') && argümanbir.endsWith('>')) {
            ...
            const embed = new Discord.MessageEmbed()
              .setTitle("Moderasyon Sistemi")
              .addFields({
                name: "Ayarlar Kaydedildi",
                value: `<#${kanalid}> kanalına gelen-giden mesajları ayarlandı`
              })
              .setColor("RANDOM")
              .setFooter("Created by Saxquatchx", fot.avatarURL({
                dynamic: true
    ...
    if (komut === "kayıt") {
      if (message.guild.id === "759428109237092382") {
        ...
        const otorolvarmi = db.has(`otorol-${message.guild.id}`);
        const atananrolvarmı = ardb.includes(`${message.guild.id}-`)
        if (otorolvarmi === false || atananrolvarmı === false) {
          const embed = new Discord.MessageEmbed()
            .setDescription(`Kayıt komutunu kullanabilmeniz için öncelikle bir otorol ayarlamalısınız ve verilecek bir rol atamalısınız <a:unlem:825146178503966770>`)
            .setFooter("Created by Saxquatchx", fot.avatarURL({
              dynamic: true
            }))
            .setColor("RED")
        ...
        const otorolgetir = db.get(`otorol-${message.guild.id}`);
        const kisi = message.mentions.members.first();
        const isim = args[1];
        const soyisim = args[2];
        const atananrol = args[3];

        if (!kisi || !isim || !soyisim || !atananrol) {
          const embed = new Discord.MessageEmbed()
            .addField(`Komutu Yanlış Kullandınız Örnek:`, `${prefix}kayıt <@kayıt olacak kişi> <ismi> <yaşı veya soy ismi> <daha önceden bir kelimeye atamış olduğunuz rol>`)
            .setFooter("Created by Saxquatchx", fot.avatarURL({
              dynamic: true
            }))
            .setColor("RED")
        ...
        const yazılanatananrolvarmı = ardb.has(`${message.guild.id}-${atananrol}`);
        if (yazılanatananrolvarmı === false) {
          const embed = new Discord.MessageEmbed()
            .addField(`Komutu Yanlış Kullandınız Örnek:`, `${prefix}kayıt <@kayıt olacak kişi> <ismi> <yaşı veya soy ismi> <daha önceden bir kelimeye atamış olduğunuz rol>`)
            .setFooter("Created by Saxquatchx", fot.avatarURL({
              dynamic: true
        ...
        const atananrolgetir = ardb.get(`${message.guild.id}-${atananrol}`);

        await kisi.roles.remove(otorolgetir);
        await kisi.setNickname(`${isim} ${soyisim}`);
        await kisi.roles.add(atananrolgetir);

        const kayıtedildi = new Discord.MessageEmbed()
          .setTitle(`Kayıt Başarılı`)
          .setDescription(`${kisi} kişisi <@&${atananrolgetir}> rolü ile kayıt edildi <a:ysltk:749379707556069457>`)
          .setFooter("Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
          .setColor("GREEN")
          .setTimestamp()
        message.channel.send(kayıtedildi);
      }
    }
    if (komut === "kick") {
          ...
          if (rol.startsWith('<@&') && rol.endsWith('>')) {
            ...
            if (logkanalvarmı === true) {
              ...
              const embed = new Discord.MessageEmbed()
                .setTitle("Moderasyon Sistemi")
                .addFields({
                  name: "Oto rol ayarlandı",
                  value: `Otorol <@&${rolid}> olarak ayarlandı`
                })
                .setColor("RANDOM")
                .setFooter("Created by Saxquatchx", fot.avatarURL({
                  dynamic: true
    ...
    if (komut === "kur") {
      ...
      setTimeout(async () => {
        ...
        setTimeout(async () => {
          ...
          await akoşkotextgetir.setParent(akoşkokategorigetir.id, {
          ...
          await akoşkosesgetir.setParent(akoşkokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await bekarlarodasıgetir.setParent(akoşkokategorigetir.id, {
            lockPermissions: true
          });
        }, 40000);
        ...
        setTimeout(async () => {
          ...
          await duyurulargetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await destekgetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await gelengidengetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await sayaçgetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await rolseçimgetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await renkseçimgetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await botkomutgetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await loggetir.setParent(önemlikategorigetir.id, {
            lockPermissions: true
          });
        ...
        setTimeout(async () => {
          ...
          await genelgetir.setParent(seskanallarıkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await bosyapmaodasıgetir.setParent(seskanallarıkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await sövmegetir.setParent(seskanallarıkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await canlıgetir.setParent(seskanallarıkategorigetir.id, {
            lockPermissions: true
          });
        }, 43000);
        ...
        setTimeout(async () => {
          ...
          await chatgetir.setParent(metinkanallarıkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await memesgetir.setParent(metinkanallarıkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await reklamgetir.setParent(metinkanallarıkategorigetir.id, {
            lockPermissions: true
          });
        }, 44000);
        ...
        setTimeout(async () => {
          ...
          await spotifygetir.setParent(müzikkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await müzikkomutgetir.setParent(müzikkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await müzikdinlemegetir.setParent(müzikkategorigetir.id, {
            lockPermissions: true
          });
        }, 45000);
        ...
        setTimeout(async () => {
          ...
          await videomontajgetir.setParent(işsizkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await photoshopgetir.setParent(işsizkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await kodgetir.setParent(işsizkategorigetir.id, {
            lockPermissions: true
          });
        }, 46000);
        ...
        setTimeout(async () => {
          ...
          await animegetir.setParent(izleyicikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await dizigetir.setParent(izleyicikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await filmgetir.setParent(izleyicikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await spoilergetir.setParent(izleyicikategorigetir.id, {
            lockPermissions: true
          });
          ...
          await dizifilmgetir.setParent(izleyicikategorigetir.id, {
            lockPermissions: true
          });
        }, 47000);
        ...
        setTimeout(async () => {
          ...
          await nsfwgetir.setParent(müstehcenkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await hentaigetir.setParent(müstehcenkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await linkgetir.setParent(müstehcenkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await görsellergetir.setParent(müstehcenkategorigetir.id, {
            lockPermissions: true
          });
        }, 48000);
        ...
        setTimeout(async () => {
          ...
          await tshirtgetir.setParent(avkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await pantulgetir.setParent(avkategorigetir.id, {
            lockPermissions: true
          });
        }, 49000);
        ...
        setTimeout(async () => {
          ...
          await taktikgetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await dereceligetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await derecesizgetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await spikegetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await özelgetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
          ...
          await tırmanışgetir.setParent(valokategorigetir.id, {
            lockPermissions: true
          });
        }, 50000);
        ...
        setTimeout(async () => {
          ...
          await taktikplangetir.setParent(cskategorigetir.id, {
            lockPermissions: true
          });
          ...
          await rekogetir.setParent(cskategorigetir.id, {
            lockPermissions: true
          });
          ...
          await yoldaşgetir.setParent(cskategorigetir.id, {
            lockPermissions: true
          });
          ...
          await othermodgetir.setParent(cskategorigetir.id, {
            lockPermissions: true
          });
        }, 51000);
        ...
        setTimeout(async () => {
          ...
          await mcservergetir.setParent(mckategorigetir.id, {
            lockPermissions: true
          });
          ...
          await mcserverbirgetir.setParent(mckategorigetir.id, {
            lockPermissions: true
          });
          ...
          await mcserverikigetir.setParent(mckategorigetir.id, {
            lockPermissions: true
          });
        }, 52000);
        ...
        setTimeout(async () => {
          ...
          await türetmecegetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await tuttugetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await vampirgetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await gtagetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await l4d2getir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await garticgetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
          ...
          await rlgetir.setParent(digerkategorigetir.id, {
            lockPermissions: true
          });
        }, 53000);
        ...
        setTimeout(async () => {
          ...
          await afkgetir.setParent(afkkategorigetir.id, {
            lockPermissions: true
          });
  ...
  Beyaz :white_circle:`
        ...
        setTimeout(async () => {
          ...
          const embeds = new Discord.MessageEmbed()
            .addFields({
              name: "Emoji Rol Ayarlandı",
              value: `Emoji Rol ${rolseçimgetir} ve ${renkseçimgetir} Kanallarında Etkinleştirildi <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Gelen-Giden Kanalı Ayarlandı",
              value: `Gelen Giden Mesajları ${gelengidengetir} Kanalına Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "İzinler Senkronize Edildi",
              value: `Kategori Ve Kanal İzinleri Senkronize Edildi <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Sistem Kanalı Ayarlandı",
              value: `Sistem Kanalı Olarak ${loggetir} Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Otorol Ayarlandı",
              value: `Otorol Olarak ${geninrolgetir} Rolü Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Log Kanalı Ayarlandı",
              value: `Log Kanalı Olarak ${loggetir} Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Afk Kanalı Ayarlandı",
              value: `Afk Kanalı Olarak ${afkgetir} Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Küfür Koruma Aktif Edildi",
              value: `Küfür Koruma Aktif Hale Getirildi <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Emojiler Ayarlandı",
              value: `9 Adet Emoji Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            }, {
              name: "Roller Ayarlandı",
              value: `27 Adet Rol Ayarlandı <a:ysltk:749379707556069457>`,
              inline: false
            })
            .setColor("GREEN")
    ...
    if (komut === "pp") {
      ...
      if (kisi) {
        ...
        const ppattachment = new Discord.MessageAttachment(canvas.toBuffer())
        message.channel.send('', ppattachment);
...
https://discord.gg/${davet.code}`);
    ...
    if (komut === "rol-ata") {
      ...
      if (!kelime || !rol) {
        const embed = new Discord.MessageEmbed()
          .setDescription("Bu komut için bir kelime ve bir rol girmelisiniz")
          .addField("Örnek: ", "<kelime> <@rol>")
          .setColor("RED")
          .setFooter("Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
      ...
      const kelimedevarmı = ardb.has(`${message.guild.id}-${kelime}`);
      if (kelimedevarmı === true) {
        const kelimedekinigetir = ardb.get(`${message.guild.id}-${kelime}`);
        const embed = new Discord.MessageEmbed()
          .setDescription(`Bu kelime için zaten <@&${kelimedekinigetir}> rolü atanmış`)
          .setColor("RED")
          .setFooter("Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
      ...
      ardb.set(`${message.guild.id}-${kelime}`, `${rol.id}`);
      const rolatandı = new Discord.MessageEmbed()
        .setDescription(`${kelime} kelimesi için ${rol} rolü atandı <a:ysltk:749379707556069457>`)
        .setColor("GREEN")
        .setFooter("Created by Saxquatchx", fot.avatarURL({
          dynamic: true
        }))
        .setTimestamp()
      message.channel.send(rolatandı);
    }
    if (komut === "müzik-odası") {
      const kanal = message.mentions.channels.first();

      if (!kanal) {
        const embed = new Discord.MessageEmbed()
          .setDescription("Bu komutu kullanırken bir kanal etiketlemelisiniz")
          .setColor("RED")
          .setFooter("Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
      ...
      const kanalvarmı = db.has(`müzikodası-${message.guild.id}`);
      if (kanalvarmı === true) {
        const kanalgetir = db.get(`müzikodası-${message.guild.id}`);
        const embed = new Discord.MessageEmbed()
          .setDescription(`Zaten bu sunucu için <#${kanalgetir}> kanalı etkinleştirilmiş`)
          .setColor("RED")
          .setFooter("Created by Saxquatchx", fot.avatarURL({
            dynamic: true
          }))
      ...
      db.set(`müzikodası-${message.guild.id}`, kanal.id);
      const embed = new Discord.MessageEmbed()
        .setDescription(`Müzik odası olarak ${kanal} kanalı etkinleştirildi <a:ysltk:749379707556069457>`)
        .setColor("GREEN")
        .setFooter("Created by Saxquatchx", fot.avatarURL({
          dynamic: true
        }))
